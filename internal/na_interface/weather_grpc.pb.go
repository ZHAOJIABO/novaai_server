...
const (
	WeatherService_GetTomorrowWeather_FullMethodName = "/weather.WeatherService/GetTomorrowWeather"
)
...
func (c *weatherServiceClient) GetTomorrowWeather(ctx context.Context, in *WeatherRequest, opts ...grpc.CallOption) (*WeatherResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WeatherResponse)
	err := c.cc.Invoke(ctx, WeatherService_GetTomorrowWeather_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedWeatherServiceServer) GetTomorrowWeather(context.Context, *WeatherRequest) (*WeatherResponse, error) {
...
func _WeatherService_GetTomorrowWeather_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WeatherRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WeatherServiceServer).GetTomorrowWeather(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WeatherService_GetTomorrowWeather_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WeatherServiceServer).GetTomorrowWeather(ctx, req.(*WeatherRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _WeatherService_GetTomorrowWeather_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/na_interface/weather.proto",
}
